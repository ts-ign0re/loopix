...
enum FilmEmulations {
    ...
    static let ap3 = FilterPreset(
        ...
        parameters: FilterParameters(
            ...
            clarity: 10,
            grain: GrainData(amount: 28, size: 0.6, roughness: 0.6, monochromatic: true),
    ...
    static let bw2 = FilterPreset(
        ...
        parameters: FilterParameters(
            ...
            skinToneSaturation: 0,
            clarity: 18,
            grain: GrainData(amount: 32, size: 0.6, roughness: 0.65, monochromatic: true),
            vignette: VignetteData(amount: 15, midpoint: 0.5, roundness: 0, feather: 0.6),
            fade: 3,
            bloom: .none,
            halation: .none,
    ...
    static let bw4 = FilterPreset(
        ...
        parameters: FilterParameters(
            ...
            skinToneSaturation: 0,
            clarity: 28,
            grain: GrainData(amount: 42, size: 0.6, roughness: 0.65, monochromatic: true),
    ...
    static let bw5 = FilterPreset(
        ...
        parameters: FilterParameters(
            ...
            skinToneSaturation: 0,
            clarity: 15,
            grain: GrainData(amount: 25, size: 0.6, roughness: 0.6, monochromatic: true),
    ...
    static let va1 = FilterPreset(
        ...
        parameters: FilterParameters(
            ...
            skinToneSaturation: -10,
            clarity: -10,
            grain: GrainData(amount: 38, size: 0.6, roughness: 0.65, monochromatic: true),
