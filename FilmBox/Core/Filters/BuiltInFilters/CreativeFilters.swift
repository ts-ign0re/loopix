...
enum CreativeFilters {
    ...
    static let arctic = FilterPreset(
        ...
        parameters: FilterParameters(
            ...
            clarity: 20,
            grain: GrainData(amount: 5, size: 0.3, roughness: 0.4, monochromatic: false),
    ...
    static let oceanBreeze = FilterPreset(
        ...
        parameters: FilterParameters(
            ...
            clarity: 12,
            grain: GrainData(amount: 8, size: 0.35, roughness: 0.45, monochromatic: false),
    ...
    static let moonlight = FilterPreset(
        ...
        parameters: FilterParameters(
            ...
            clarity: 10,
            grain: GrainData(amount: 12, size: 0.4, roughness: 0.5, monochromatic: false),
    ...
    static let sunsetBlaze = FilterPreset(
        ...
        parameters: FilterParameters(
            ...
            skinToneSaturation: 5,
            clarity: 15,
            grain: GrainData(amount: 10, size: 0.4, roughness: 0.5, monochromatic: false),
    ...
    static let softGlow = FilterPreset(
        ...
        parameters: FilterParameters(
            ...
            clarity: -10,
            grain: GrainData(amount: 5, size: 0.25, roughness: 0.35, monochromatic: false),
    ...
    static let streetGrit = FilterPreset(
        ...
        parameters: FilterParameters(
            ...
            skinToneSaturation: 0,
            clarity: 30,
            grain: GrainData(amount: 25, size: 0.55, roughness: 0.65, monochromatic: false),
    ...
    static let neonCity = FilterPreset(
        ...
        parameters: FilterParameters(
            ...
            skinToneSaturation: -5,
            clarity: 18,
            grain: GrainData(amount: 15, size: 0.45, roughness: 0.55, monochromatic: false),
    ...
    static let concreteJungle = FilterPreset(
        ...
        parameters: FilterParameters(
            ...
            skinToneSaturation: 0,
            clarity: 22,
            grain: GrainData(amount: 18, size: 0.5, roughness: 0.55, monochromatic: false),
    ...
    static let fadedMemory = FilterPreset(
        ...
        parameters: FilterParameters(
            ...
            skinToneSaturation: 5,
            clarity: -5,
            grain: GrainData(amount: 30, size: 0.6, roughness: 0.65, monochromatic: false),
            vignette: VignetteData(amount: 25, midpoint: 0.45, roundness: 0, feather: 0.55),
            fade: 25,
    ...
    static let agedPaper = FilterPreset(
        ...
        parameters: FilterParameters(
            ...
            skinToneSaturation: 8,
            clarity: -8,
            grain: GrainData(amount: 35, size: 0.65, roughness: 0.7, monochromatic: false),
